...
public:
     ...
     */
    inline RVector() : x(0.0),y(0.0),z(0.0), valid(true) {
    }
    ...
    RVector(const QPointF& pt, bool valid_in = true);
    ...
    //    friend QDataStream &operator>>(QDataStream & input, RVector &obj){
    //        input >> obj.x>>obj.y>>obj.z>>obj.valid;
    //        return input;
    //    }
    //    friend QDataStream &operator<<(QDataStream & output, const RVector &obj){
    //        output <<obj.x<<obj.y<<obj.z<<obj.valid;
