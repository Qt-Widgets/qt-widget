...
public:
    explicit ColorSwatch(const QString &colorName, QWidget *widget, QMainWindow *parent = nullptr, Qt::WindowFlags flags = nullptr);
...
class BlueTitleBar : public QWidget
{
    Q_OBJECT
public:
    explicit BlueTitleBar(const QString& title,QWidget *parent = nullptr);
