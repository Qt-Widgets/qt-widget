...
public:
    ...
    static QByteArray Crypt(MyAes::Aes level, MyAes::Mode mode, const QByteArray &rawText, const QByteArray &key,
                            const QByteArray &iv = NULL, MyAes::Padding padding = MyAes::ISO);
    static QByteArray Decrypt(MyAes::Aes level, MyAes::Mode mode, const QByteArray &rawText, const QByteArray &key,
                              const QByteArray &iv = NULL, MyAes::Padding padding = MyAes::ISO);
    static QByteArray ExpandKey(MyAes::Aes level, MyAes::Mode mode, const QByteArray &key);
    static QByteArray RemovePadding(const QByteArray &rawText, MyAes::Padding padding);

    MyAes(MyAes::Aes level, MyAes::Mode mode,
                   MyAes::Padding padding = MyAes::ISO);
